...
//	 * @return: WebErrors
//	 */
//	public static WebErrors authCheck(HttpServletRequest request,WebErrors e,byte oldStatus,ContentOperateType newStatus){
//		List ds = ContentCheck.getValiDS(oldStatus);
//		if(ds!=null&&!ds.contains(newStatus)){
//			e.addErrorCode(Constants.CONTENT_STATUS_EDIT_ERROR);
//		}
//		return e;
//	} 
